$("#saddress1").on('change keyup paste', function() {
        ...
        $("#raddress3").on('change keyup paste', function() {
            $("#raddress3-show").html($("#raddress3").val());
        });
        ...
        document.getElementById('sample-output').style.height = soHeight + 57 + 'px';
        ...
        function changeOutputWindow(x) {
            if (x.matches) {
                ...
                //   document.getElementById('sample-output').style.height = offsetHeight;
            }
        }
